                            ...
                            <div className="border-b border-gray-900/10 pb-12">
                                ...
                                <ul >
                                    {addresses.map((address) => (
                                        <li key={address.phone} className="flex justify-between gap-x-6 p-5 border-solid border-2 border-gray-200 m-x-4 ">
                                ...
                                <div className="mt-10 space-y-10">
                                    ...
                                    <fieldset>
                                        ...
                                        <p className="mt-1 text-sm leading-6 text-gray-600">Chash one</p>
                                    ...
                                    {products.map((product) => (
                                        <li key={product.id} className="flex py-6">
                                            ...
                                            <div className="ml-4 flex flex-1 flex-col">
                                                <div>
                                                    <div className="flex justify-between text-base font-medium text-gray-900 mr-5">
                                                        <h3>
